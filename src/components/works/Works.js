  ...
  const [projects, setProjects] = useState([
    {
      ...
      technologies: `React-TypeScript, Redux, Redux-saga, Google API, Material UI, Node, Express, MongoDB, AWS EC2, S3, Formik`,
    ...
    },
    {
      ...
      technologies: `ReactJS, Redux, Redux-Saga, Material-UI, SASS, ChartJS, Node, Express, MongoDB, AWS EC2, S3, Formik`,
      alter: "Startup Project",
      image: `${Homaze}`,
    },
    {
      ...
      technologies: `React-TypeScript, Redux-toolkit, Ant-Design, Tailwind CSS, Auth0, Redux-Thunk, SASS, Styled-components, Recharts`,
