...
export const About = () => {
  ...
  Engineer with 2 years of industrial
  experience in MERN stack. I've always 
  found coding intuitive and have 
  pushed myself to learn the most 
  effective ways to achieve a result. I can 
  adapt to any technology rapidly 
  making myself flexible upon any tech 
  stack and can quickly integrate into a 
  team.`;
  const aboutMe2 =
